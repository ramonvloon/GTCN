...
<div align="center">
	...
	<div id="duoselectionbuttons"><a href="lessen.php">Lessen</a><a href="toetsen.php">Toetsen</a>
    <?}
	else{ ?>
...
if (isset($_SESSION['username'])) {
?><BLOCKQUOTE>
Kies uit het menu boven wat u wilt gaan doen.
<p>Bij lessen krijgt u over verschillende programmeertalen de basis informatie.
<p>Bij toetsen wordt u getoetst over de lessen die u heeft kunnen leren en u kunt hier kijken
of u de stof al beheerst</BLOCKQUOTE>
<?php } else{
